...
namespace DoctorPortal.Data
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public void Initialize()
        {
            ...
            _userManager.CreateAsync(new ApplicationUser()
            {
                UserName = "b181200048@gmail.com",
                Name = "Hande",
                Surname = "Özen",
                TC = "11111111111",
                Gender = "K",
                Email = "b181200048@gmail.com",
                EmailConfirmed = true,
                PhoneNumber = "1112223344"
            }, "Pat123#").GetAwaiter().GetResult();

            _userManager.AddToRoleAsync(_db.Users.FirstOrDefaultAsync(u => u.Email == "b181200048@gmail.com").GetAwaiter().GetResult(), "Patient").GetAwaiter().GetResult();
            ...
            _db.SaveChanges();
            ApplicationUser patient = _db.Users.FirstOrDefaultAsync(u => u.Email == "b181200048@gmail.com").GetAwaiter().GetResult();
            ApplicationUser doctor = _db.Users.FirstOrDefaultAsync(u => u.Email == "doc@gmail.com").GetAwaiter().GetResult();
